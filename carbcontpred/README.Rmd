...
## Extract an algebraic equation based on the results of your linear regression model
## Load the ROI data table and and apply continuum removal over the reflectance values
## Use the algebraic equation to predict organic carbon content of points in the ROI data table based on their reflectance values
