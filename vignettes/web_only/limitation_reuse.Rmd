...
It should be noted that using the two softwares ENVI and ArcGIS Pro for extraction and visualization of an ROI data file respectively as shown in this [article](https://kangyuso.github.io/carbcontpred/articles/web_only/ROI_Files.html) can lead to some loss of data. For example, visualizing the ````ROI_Predicted_Carbon.csv```` data file on ArcGIS Pro leads to some of the data missing in the raster:
